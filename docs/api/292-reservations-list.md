...
**source\_types**SourceType (string)\[\]
...
```
{  "data": [    {      "id": "018d79a1-2b99-7fbd-b323-500b01305371",      "plannable_item": {        "type": "plannableItem",        "id": "46156648-87c6-478d-8aa7-1dc3a00dacab"      },      "date": "2024-01-02",      "duration": {        "value": 60,        "currency": "minutes"      },      "assignee": null,      "origin": null,      "source": {        "type": "task",        "id": "948b8ca5-58aa-0844-ba34-cee255aa9694"      }    }  ]}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/reservations.list");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"plannable_item_ids\": [\n    \"46156648-87c6-478d-8aa7-1dc3a00dacab\"\n  ]\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "plannable\_item\_ids": \[    "46156648-87c6-478d-8aa7-1dc3a00dacab"  \]
}
Send API Request
