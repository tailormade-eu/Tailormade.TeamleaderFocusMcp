...
> Source: https://developer.focus.teamleader.eu/docs/api/credit-notes-download
...
## https://api.focus.teamleader.eu/creditNotes.download
...
```
{  "data": {    "location": "https://cdn.teamleader.eu/file",    "expires": "2018-02-05T16:44:33+00:00"  }}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/creditNotes.download");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"id\": \"d885e5d5-bacb-4607-bde9-abc4a04a901b\",\n  \"format\": \"pdf\"\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "id": "d885e5d5-bacb-4607-bde9-abc4a04a901b",  "format": "pdf"
}
Send API Request
...
](/docs/api/credit-notes-send-via-peppol)