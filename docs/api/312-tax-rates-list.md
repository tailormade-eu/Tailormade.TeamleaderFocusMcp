...
```
{  "data": [    {      "id": "c93ddb52-0af8-47d9-8551-441435be66a7",      "description": "21%",      "rate": 0.21,      "department": {        "type": "department",        "id": "182af0a8-3f68-409b-8941-cf8caf8f28a0"      }    }  ]}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/taxRates.list");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"filter\": {\n    \"department_id\": \"080aac72-ff1a-4627-bfe3-146b6eee979c\"\n  },\n  \"page\": {\n    \"size\": 20,\n    \"number\": 1\n  },\n  \"sort\": [\n    {\n      \"field\": \"department_id\",\n      \"order\": \"asc\"\n    }\n  ]\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "filter": {    "department\_id": "080aac72-ff1a-4627-bfe3-146b6eee979c"  },  "page": {    "size": 20,    "number": 1  },  "sort": \[    {      "field": "department\_id",      "order": "asc"    }  \]
}
Send API Request
