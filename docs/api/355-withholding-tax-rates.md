...
> Source: https://developer.focus.teamleader.eu/docs/api/withholding-tax-rates
...
## 📄️ withholdingTaxRates.list

Get a list of available withholding tax rates.

](/docs/api/withholding-tax-rates-list)
