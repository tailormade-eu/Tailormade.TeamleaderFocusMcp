...
```
{  "data": [    {      "id": "c93ddb52-0af8-47d9-8551-441435be66a7",      "department": {        "type": "department",        "id": "182af0a8-3f68-409b-8941-cf8caf8f28a0"      },      "description": "Ritenuta d'acconto 23% su 20%",      "rate": 0.046    }  ]}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/withholdingTaxRates.list");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"filter\": {\n    \"department_id\": \"080aac72-ff1a-4627-bfe3-146b6eee979c\"\n  }\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "filter": {    "department\_id": "080aac72-ff1a-4627-bfe3-146b6eee979c"  }
}
Send API Request
...
](/docs/api/withholding-tax-rates)[

Next

Commercial Discounts

](/docs/api/commercial-discounts)