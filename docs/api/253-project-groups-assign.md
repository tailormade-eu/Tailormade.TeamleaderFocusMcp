...
> Source: https://developer.focus.teamleader.eu/docs/api/project-groups-assign
...
## https://api.focus.teamleader.eu/projects-v2/projectGroups.assign
...
](/docs/api/project-groups-delete)[
