...
```
{  "data": [    {      "id": "05676ac4-c61d-42bf-a3ea-a420fc1ec017",      "date": "2023-12-21"    }  ],  "meta": {    "page": {      "size": 10,      "number": 2    },    "matches": 12  }}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/closingDays.list");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"filter\": {\n    \"date_before\": \"2023-12-31\",\n    \"date_after\": \"2023-12-01\"\n  },\n  \"page\": {\n    \"size\": 20,\n    \"number\": 1\n  }\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "filter": {    "date\_before": "2023-12-31",    "date\_after": "2023-12-01"  },  "page": {    "size": 20,    "number": 1  }
}
Send API Request
