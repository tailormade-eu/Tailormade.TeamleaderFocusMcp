...
> Source: https://developer.focus.teamleader.eu/docs/api/webhooks-list
...
## https://api.focus.teamleader.eu/webhooks.list
...
```
{  "data": [    {      "url": "https://example.com",      "types": [        "account.deactivated"      ]    }  ]}
```
...
](/docs/api/webhooks-register)[

Next

webhooks.unregister

](/docs/api/webhooks-unregister)