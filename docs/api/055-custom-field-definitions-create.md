...
```
{  "data": {    "type": "customFieldDefinition",    "id": "526960d3-8d49-4a71-9f62-7b8b74aef058"  }}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/customFieldDefinitions.create");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"label\": \"\",\n  \"type\": \"single_line\",\n  \"context\": \"contact\"\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "label": "",  "type": "single\_line",  "context": "contact"
}
Send API Request
