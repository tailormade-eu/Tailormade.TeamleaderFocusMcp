...
**extra\_option\_allowed**boolean
...
```
{  "data": [    {      "id": "74855f4a-2b61-429c-81d8-c79ad3675a76",      "context": "contact",      "type": "single_line",      "label": "",      "group": "",      "required": false,      "configuration": {        "options": [          {            "id": "179e1564-493b-4305-8c54-a34fc80920fc",            "value": "foo"          }        ],        "extra_option_allowed": true      }    }  ]}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/customFieldDefinitions.list");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"filter\": {\n    \"ids\": [\n      \"9c64570b-4ec1-4e03-9662-af904f78f7fa\",\n      \"aa6d2560-63f9-4b2f-bf96-823dc7c34df7\"\n    ]\n  },\n  \"page\": {\n    \"size\": 20,\n    \"number\": 1\n  },\n  \"sort\": [\n    {\n      \"field\": \"label\"\n    }\n  ]\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "filter": {    "ids": \[      "9c64570b-4ec1-4e03-9662-af904f78f7fa",      "aa6d2560-63f9-4b2f-bf96-823dc7c34df7"    \]  },  "page": {    "size": 20,    "number": 1  },  "sort": \[    {      "field": "label"    }  \]
}
Send API Request
...
](/docs/api/custom-field-definitions-create)[

Next

customFieldDefinitions.info

](/docs/api/custom-field-definitions-info)