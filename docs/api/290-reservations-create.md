...
**plannable\_item\_id**stringrequired
...
```
{  "data": {    "type": "reservation",    "id": "019a3012-c800-7109-ae63-0ab5bcd3b484"  }}
```
...
{
  "plannable\_item\_id": "46156648-87c6-478d-8aa7-1dc3a00dacab",  "date": "2024-01-12",  "duration": {    "value": 60,    "unit": "minutes"  },  "assignee": {    "type": "user",    "id": "b38ebb9b-6e46-4bf4-a1e2-af747d6b64ae"  }
}
Send API Request
...
](/docs/api/reservations-list)[

Next

reservations.update

](/docs/api/reservations-update)