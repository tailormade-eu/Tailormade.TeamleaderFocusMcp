...
```
{  "data": {    "type": "taxRate",    "id": "6ad54ec6-ee2d-4500-afe6-0917c1aa7a38"  }}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/migrate.taxRate");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"department_id\": \"6ad54ec6-ee2d-4500-afe6-0917c1aa7a38\",\n  \"tax_rate\": \"21\"\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "department\_id": "6ad54ec6-ee2d-4500-afe6-0917c1aa7a38",  "tax\_rate": "21"
}
Send API Request
...
](/docs/api/migrate-activity-type)