...
> Source: https://developer.focus.teamleader.eu/docs/api/contacts-upload-avatar
...
## https://api.focus.teamleader.eu/contacts.uploadAvatar
...
{
  "id": "76c9d03c-ec5c-4b21-9fc6-7ffee488b12d",  "image": "data:image/png;base64,0tyZUP4y8ObjsqZnRFhHANZY+Kc="
}
Send API Request
...
](/docs/api/contacts-update-company-link)[
