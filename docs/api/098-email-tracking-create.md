...
```
{  "data": {    "type": "emailTracking",    "id": "91e99ae3-16f9-01d7-9046-9a501cb2155f"  }}
```
...
{
  "subject": {    "type": "contact",    "id": "36386b05-936e-4cc0-9523-bd20d797ebf5"  },  "title": "an email subject",  "content": "<p>the contents of the received email</p>",  "attachments": \[    "4f4288b2-c21b-4dac-87f6-a97511309079"  \]
}
Send API Request
...
](/docs/api/email-tracking-list)[

Next

Closing Days

](/docs/api/closing-days)