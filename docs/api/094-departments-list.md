...
```
{  "data": [    {      "id": "67c576e7-7e6f-465d-b6ab-a864f6e5e95b",      "name": "Human Resources",      "vat_number": "BE0899623035",      "currency": "EUR",      "emails": [        {          "type": "primary",          "email": "info@piedpiper.eu"        }      ],      "status": "active"    }  ]}
```
...
{
  "filter": {    "ids": \[      "92296ad0-2d61-4179-b174-9f354ca2157f",      "53635682-c382-4fbf-9fd9-9506ca4fbcdd"    \],    "status": \[      "active"    \]  },  "sort": \[    {      "field": "default\_department",      "order": "asc"    }  \]
}
Send API Request
...
](/docs/api/departments)[

Next

departments.info

](/docs/api/departments-info)