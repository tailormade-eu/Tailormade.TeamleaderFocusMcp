...
```
{  "data": [    {      "name": "My holiday discount",      "department": {        "type": "department",        "id": "6a6343fc-fdd8-4bc0-aa69-3a004c710e87"      }    }  ]}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/commercialDiscounts.list");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"filter\": {\n    \"department_id\": \"6a6343fc-fdd8-4bc0-aa69-3a004c710e87\"\n  }\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "filter": {    "department\_id": "6a6343fc-fdd8-4bc0-aa69-3a004c710e87"  }
}
Send API Request
