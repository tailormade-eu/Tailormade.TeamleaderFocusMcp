...
```
{  "data": [    {      "id": "f350e48a-fbc3-0a79-e62a-53aa1ae86d44",      "name": "Main Pipeline"    }  ],  "meta": {    "default": "f350e48a-fbc3-0a79-e62a-53aa1ae86d44",    "page": {      "size": 10,      "number": 2    },    "matches": 12  }}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/dealPipelines.list");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"filter\": {\n    \"ids\": [\n      \"string\"\n    ],\n    \"status\": [\n      \"open\"\n    ]\n  },\n  \"page\": {\n    \"size\": 20,\n    \"number\": 1\n  }\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "filter": {    "ids": \[      "string"    \],    "status": \[      "open"    \]  },  "page": {    "size": 20,    "number": 1  }
}
Send API Request
...
](/docs/api/deal-pipelines-create)