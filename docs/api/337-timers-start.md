...
```
{  "data": {    "type": "timer",    "id": "4ff475b2-f45b-4803-800e-350b9c02aeca"  }}
```
...
{
  "work\_type\_id": "db41328a-7a25-4e85-8fb9-830baacb7f40",  "started\_at": "2017-04-26T10:01:49+00:00",  "subject": {    "type": "milestone",    "id": "29ff471c-7d8f-40d5-8c95-9a9cab841e65"  },  "invoiceable": true
}
Send API Request
...
](/docs/api/timers-current)[

Next

timers.stop

](/docs/api/timers-stop)