...
```
{  "data": {    "type": "nextgenMaterial",    "id": "0186a2f3-32a5-7c81-b3a9-55809146ad0c"  }}
```
...
```
var client = new HttpClient();var request = new HttpRequestMessage(HttpMethod.Post, "https://api.focus.teamleader.eu/projects-v2/materials.duplicate");request.Headers.Add("Accept", "application/json");request.Headers.Add("Authorization", "Bearer <token>");var content = new StringContent("{\n  \"origin_id\": \"0186a74b-b640-7458-9717-7c84356b26fd\"\n}", null, "application/json");request.Content = content;var response = await client.SendAsync(request);response.EnsureSuccessStatusCode();Console.WriteLine(await response.Content.ReadAsStringAsync());
```
...
{
  "origin\_id": "0186a74b-b640-7458-9717-7c84356b26fd"
}
Send API Request
...
](/docs/api/nextgen-projects-materials-delete)