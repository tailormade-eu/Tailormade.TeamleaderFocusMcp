...
{
  "id": "48ef99b9-4a20-4071-888d-0927f45c03d5",  "customer": {    "type": "contact",    "id": "adfec6b9-a8d7-403d-bde3-093ad50d74c2"  },  "function": "Sales representative",  "sub\_function": null
}
Send API Request
...
](/docs/api/nextgen-projects-external-parties-add-to-project)[

Next

externalParties.delete

](/docs/api/nextgen-projects-external-parties-delete)