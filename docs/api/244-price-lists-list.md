...
```
{  "data": [    {      "id": "2aa4a6a9-9ce8-4851-a9b3-26aea2ea14c4",      "name": "price",      "calculation_method": "manual"    }  ]}
```
...
{
  "filter": {    "ids": \[      "5a37d173-78d3-05f3-b018-d51fadc1c5d2",      "97233974-7c29-05f5-a51d-fbe3238e6157"    \]  }
}
Send API Request
